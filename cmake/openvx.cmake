...
project(nnef-lib C)
file(GLOB OVX_SRC_NNEF_LIB "${KHRONOS_SRC_DIR}/kernels/NNEF-Tools/parser/cpp/src/*.cpp")
add_library(nnef-lib STATIC ${OVX_SRC_NNEF_LIB} )
target_include_directories(nnef-lib  PRIVATE ${KHRONOS_SRC_DIR}/kernels/NNEF-Tools/parser/cpp/include)
...
target_include_directories(openvx PUBLIC ${KHRONOS_SRC_DIR}/include PRIVATE ${KHRONOS_SRC_DIR}/sample/include ${KHRONOS_SRC_DIR}/kernels/NNEF-Tools/parser/cpp/include)
else ()
